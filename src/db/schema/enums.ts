...
export const analysisKind = pgEnum("analysis_kind", ["category_summary", "cycle_summary", "persona", "cycle_insights", "question_summary"]);
export const trendEnum = pgEnum("trend", ["up", "stable", "down"]);
export const chatRole = pgEnum("chat_role", ["user", "assistant"]);
export const billingCycleEnum = pgEnum("billing_cycle", ["monthly", "annual"]);
export const subscriptionStatusEnum = pgEnum("subscription_status", ["none", "pending", "active", "overdue", "canceled"]);
export const paymentStatusEnum = pgEnum("payment_status", ["pending", "confirmed", "received", "overdue", "refunded"]);
